...
Citizen.CreateThread(function()
	while true do
		...
		local ped = GetPlayerPed(-1)
     	...
     	SendNUIMessage({action = "updateHealth", value = health})
	end
end)
-- Voice
...
-- Citizen.CreateThreavd(function()
-- 	while true do
-- 		Citizen.Wait(0)
...
RegisterNetEvent('esx_customui:togBeltsOn')
AddEventHandler('esx_customui:togBeltsOn', function(show)
	SendNUIMessage({action = "togBeltsOn", show = show})
end)
RegisterNetEvent('esx_customui:togBelts')
AddEventHandler('esx_customui:togBelts', function(show)
	SendNUIMessage({action = "togBelts", show = show})
end)
RegisterNetEvent('esx_customui:togHealth')
AddEventHandler('esx_customui:togHealth', function(show)
	SendNUIMessage({action = "togHealth", show = show})
end)
...
RegisterNetEvent('esx_customui:toggle')
AddEventHandler('esx_customui:toggle', function(show)
	SendNUIMessage({action = "toggle", show = show})
	--print("UI-TOGGLE")
	--print(show)
	--print("---")
