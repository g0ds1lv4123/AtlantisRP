...
AddEventHandler('skinchanger:change', function(key, val)
	...
	--TriggerServerEvent('esx:clientLog', "[CLOTHING] [GEAR REMOVED] -> "..myname)
	RemoveGears()
	
	
	--TriggerServerEvent('esx:clientLog', "[CLOTHING] [GEAR SET] -> "..myname)
	--SetGears()
...
function RemoveGear(weapon)
	...
	Weapons = _Weapons
	local myname = NetworkPlayerGetName(PlayerId())
	--TriggerServerEvent('esx:clientLog', "[WEAPON REMOVED] " .. weapon .. " -> " .. myname)
end
-----------------------------------------------------------
-----------------------------------------------------------
...
function RemoveGears()
	...
	Weapons = {}
	local myname = NetworkPlayerGetName(PlayerId())
	--TriggerServerEvent('esx:clientLog', "[GEAR REMOVED] -> "..myname)
end
-----------------------------------------------------------
-----------------------------------------------------------
