...
function sit(object, modelName, data)
	...
	--ESX.TriggerServerCallback('esx_interact:getPlace', function(occupied)
		if IsPedSprinting(playerPed) or IsPedRunning(playerPed) then
			...
			sitanim = data.sitanim

			TaskStartScenarioAtPosition(playerPed, currentScenario, pos.x, pos.y, pos.z - data.verticalOffset, GetEntityHeading(object)+180.0, -1, sitanim, true)
