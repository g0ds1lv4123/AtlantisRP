...
function OpenBossMenu(society, close, options)
	...
	if options.showmoney then
		table.insert(elements, {label = 'Stan konta <span style="color:green;">'..fractionAccount..'$' , value = 'none'})
	end
...
function OpenEmployeeList2(society)
  ...
  ESX.TriggerServerCallback('esx_society:getEmployees2', function(employees)
    ...
    for i=1, #employees, 1 do
	    if employees[i].job2_grade == 0 then
	      table.insert(elements.rows, {
	        data = employees[i],
	        cols = {
	          employees[i].name,
      ...
      function(data, menu)
        ...
        if data.value == 'fire' then
          ...
          ESX.TriggerServerCallback('esx_society:setJob2', function()
            OpenEmployeeList2(society)
          end, employee.identifier, 'no_society', 0, 'fire')
...
function OpenPromoteMenu2(society, employee)
		...
		table.insert(elements, {label = 'Stopień pierwszy', value = 1, selected = (1)})
		table.insert(elements, {label = 'Stopień drugi', value = 2, selected = (2)})
		table.insert(elements, {label = 'Stopień trzeci', value = 3, selected = (3)})
		table.insert(elements, {label = 'Stopień czwarty', value = 4, selected = (4)})
		table.insert(elements, {label = 'Stopień piąty', value = 5, selected = (5)})
