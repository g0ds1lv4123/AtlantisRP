...
admins = {
    'steam:1100001024A5579',
    'steam:110000102730af7',
    'steam:110000104243b23',
...
function NextWeatherStage()
    ...
    elseif CurrentWeather == "CLEARING" or CurrentWeather == "OVERCAST" then
        ...
        if new == 1 then
		    ...
		    --local rainagain = math.random(3,97)
            local rainagain = math.random(0,25)
		    if rainagain < 4 then
		    	CurrentWeather = "RAIN" 
		 	    print("[vSync] Chances for rain: " .. rainagain .. "\n")	
                newWeatherTimer = 10
		    else
			    CurrentWeather = "EXTRASUNNY"
			     print("[vSync] Chances for extrasunny: " .. rainagain .. "\n")
		    end
	    end
        elseif new == 2 then
